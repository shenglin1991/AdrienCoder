...
namespace AdrienCoder.Api.Infrastructure;
...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddIndexingFeature(
        this IServiceCollection services)
    {
        services.AddScoped<RepoScannerService>();
        services.AddScoped<CodeChunkerService>();
        services.AddScoped<RepositoryIndexingService>();
        services.AddSingleton<RepoIndexStore>();
